        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">  
                    <h2 class="h2-main">Dodaj konto osobiste</h2>
                    <form action="save_account.php" style="margin-top:20%" method="post">
                    <!nazwaodbiorcy, tytulprzelewu>
                    <label class="main-label label-white" for="NazwaKonta">Nazwa konta:</label><br>
                    <input class="input-main" style="text-align:center;" placeholder="Podaj nazwę konta"  type="text" id="NazwaKonta" name="NazwaKonta" required><br>
