    ...
    ?>
        ...
        <div class="container">
            <div class="row">
                ...
                echo "<h2 class='h2-main details-margin'> Szczegóły konta o numerze <b>".$wiersz['NrKonta']."</b></h2>";
                ...
                echo "<a href=\"create_payment.php?nrKonta=".$nrKonta."\"><div class='account-button margin-separator'>Dodaj wpłatę</div></a>";
                echo "<br>";
