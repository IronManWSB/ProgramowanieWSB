...
?>
  ...
  <input class="input-main" type="text" id="nazwaOdbiorcy" name="odbiorca" required><br>
  <label class="main-label label-white" for="tytulPrzelewu">Tytuł przelewu:</label><br>
  <input class="input-main" type="text" id="tytulPrzelewu" name="tytulPrzelewu" required><br>
